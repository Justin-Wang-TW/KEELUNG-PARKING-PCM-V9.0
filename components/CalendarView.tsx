...
import { Task, TaskStatus, User, StationCode, UserRole } from '../types';
...
const CalendarView: React.FC<CalendarViewProps> = ({ tasks, currentUser, onEditTask }) => {
    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">檢視各項任務之截止期限</p>
        </div>
